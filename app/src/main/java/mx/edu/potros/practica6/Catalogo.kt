...
class Catalogo : AppCompatActivity() {
    ...
    private fun cargarPeliculas() {
        ...
        series.add(Pelicula("Avatar: La leyenda de Aang\n",R.drawable.ant,R.drawable.ant,"La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego.   "))
