...
class Catalogo : AppCompatActivity() {
    ...
    private fun cargarPeliculas() {
        ...
        peliculas.add(Pelicula("DUNE2",R.drawable.dune,R.drawable.dune2,"\"Duna: Parte Dos\" explorará el viaje mítico de Paul Atreides mientras se une con Chani y los Fremen mientras está en un camino de venganza contra los conspiradores que destruyeron a su familia. Enfrentando una elección entre el amor de su vida y el destino del universo conocido, se esfuerza por evitar un futuro terrible que solo él pueda prever.\n"))
        peliculas.add(Pelicula("Ghostbusters Apocalipsis",R.drawable.ghostposter,R.drawable.ghostbusters,"En Ghostbusters Apocalipsis Fantasma, regresa la familia Spengler a donde todo empezó – la icónica estación de bomberos en Nueva York – donde hace equipo junto con los Ghostbusters originales que han desarrollado un laboratorio de investigación ultrasecreto para llevar la cacería de fantasmas al siguiente nivel. Pero cuando el descubrimiento de un artefacto antiguo libera una fuerza maligna, los nuevos y viejos Ghostbusters unen sus fuerzas para proteger su hogar y salvar al mundo de una segunda era de hielo. "))
        ...
        series.add(Pelicula("Avatar: La leyenda de Aang\n",R.drawable.ant,R.drawable.avatarportada,"La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego.   "))
        ...
        series.add(Pelicula("Mi adorable demonio\n",R.drawable.adorabledemonio,R.drawable.adorabledemonios," Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.  "))
        series.add(Pelicula("El Monstruo de la Vieja Seúl\n",R.drawable.elmonstruo,R.drawable.elmonstruovieja,"  Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana. "))
        series.add(Pelicula("Witcher",R.drawable.thewitcher,R.drawable.thewitchers," Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo turbulento en el que, a menudo, los humanos son peores que las bestia  "))
    }
